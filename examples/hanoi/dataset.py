...
def training_code_identity() -> str:
    ...
    paths.extend(
        ...
        for path in (
            "scripts/train.py",
            "examples/hanoi/train.py",
            "examples/hanoi/qualify.py",
            "examples/hanoi/dataset.py",
            "examples/hanoi/compute_norm_stats.py",
            "examples/hanoi/execution.py",
            "examples/hanoi/storage.py",
            "examples/hanoi/telemetry.py",
        )
    )
    digest = hashlib.sha256()
